# Messages
The bitcoin protocol specifies a set of [messages](https://en.bitcoin.it/wiki/Protocol_specification) that can be sent from peer to peer. `@navcoin/bitcore-p2p` provides support for some of these messages.

# Peer
Represents a node from the p2p Navcoin network. The Peer class supports connecting directly to other nodes or through a socks5 proxy like Tor.
...
```javascript
var p2p = require('@aguycalled/bitcore-p2p')
var Peer = p2p.Peer;

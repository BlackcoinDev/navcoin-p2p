...
/**
 * A convenience constructor for Inventory for dandelion transaction inventory types.
 * @param {Buffer|String} hash - The hash for the dandelion transaction inventory
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forDandelionTransaction = function(hash) {
  return Inventory.forItem(Inventory.TYPE.DANDELION_TX, hash);
};

/**
 * A convenience constructor for Inventory for encrypted candidate inventory types.
 * @param {Buffer|String} hash - The hash for the encrypted candidate inventory
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forEncCand = function(hash) {
  return Inventory.forItem(Inventory.TYPE.ENCCAND, hash);
};

/**
 * A convenience constructor for Inventory for aggregated sessions inventory types.
 * @param {Buffer|String} hash - The hash for the aggregated sessions inventory
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forAggSession = function(hash) {
  return Inventory.forItem(Inventory.TYPE.AGGSESSION, hash);
};

/**
 * A convenience constructor for Inventory for dandelion encrypted candidate inventory types.
 * @param {Buffer|String} hash - The hash for the dandelion encrypted candidate inventory
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forDandelionEncCand = function(hash) {
  return Inventory.forItem(Inventory.TYPE.DANDELION_ENCCAND, hash);
};

/**
 * A convenience constructor for Inventory for dandelion aggregated sessions inventory types.
 * @param {Buffer|String} hash - The hash for the dandelion aggregated sessions inventory
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forDandelionAggSession = function(hash) {
  return Inventory.forItem(Inventory.TYPE.DANDELION_AGGSESSION, hash);
};
...
Inventory.TYPE.DANDELION_ENCCAND = 3;
Inventory.TYPE.ENCCAND = 4;
Inventory.TYPE.DANDELION_AGGSESSION = 5;
Inventory.TYPE.AGGSESSION = 6;
Inventory.TYPE.FILTERED_BLOCK = 7;
Inventory.TYPE.CMPCT_BLOCK = 8;
Inventory.TYPE.DANDELION_TX = 9;
Inventory.TYPE_NAME = [
  'ERROR',
  'TX',
  'BLOCK',

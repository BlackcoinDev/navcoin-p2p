 ...
 * @constructor
 */
function EncCand(arg, options) {
  Message.call(this, options);
  this.command = 'enccand';
  if (!arg) {
    arg = {};
  }
...
inherits(EncCand, Message);

EncCand.prototype.setPayload = function(payload) {
...
EncCand.prototype.getPayload = function() {
